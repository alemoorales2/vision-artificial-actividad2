...
I07 & Satélite & gaussian\_s1 & 0.908 & 0.007 & 0.111 \\
I08 & Satélite & gaussian\_s1 & 0.871 & 0.020 & 0.201 \\
I09 & Satélite & unsharp\_r1\_a1 & 0.949 & 0.061 & 0.363 \\
\bottomrule
\end{tabular}
\end{table}
...
En escenas fluviales (I07, clase River), el Gaussiano equilibra suavizado y preservación de los contornos del cauce. En carreteras (I08, clase Highway), la mediana preserva las líneas de la carretera mientras reduce ruido de vegetación. En zonas industriales/portuarias (I09, clase Industrial), unsharp realza las estructuras de los barcos y edificaciones con incremento moderado de ruido.
...
Satélite & I07 & closing\_r2 & 18 & 892 & 0.875 \\
Satélite & I08 & opening\_r2 & 24 & 1056 & 0.862 \\
\bottomrule
\end{tabular}
\end{table}
...
\caption{Comparativa visual en escena satelital fluvial (I07, River de EuroSAT): efectos de suavizado y realce sobre el cauce y vegetación.}
\label{fig:comp_I07}
\end{figure}
...
\end{minipage}
\caption{Histogramas normalizados por dominio: (arriba-izq.) I01 radiografía con distribución bimodal; (arriba-der.) I04 industrial con pico dominante; (abajo) I07 satélite fluvial (River) con distribución característica de zonas acuáticas. El Gaussiano conserva la forma global mientras unsharp expande el rango dinámico.}
